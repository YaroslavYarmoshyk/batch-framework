...
/**
 * Resolves the configured resource paths (see {@code system-configuration.resources}) so they work
 ...
 * If neither yields an existing file (e.g. an output file that is about to be created) the
